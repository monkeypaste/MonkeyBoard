...
public partial class MainView : UserControl {
    ...
    protected override void OnLoaded(RoutedEventArgs e) {
        ...
        TestButton.Click += async (s, e) => {
            ...
            //var test = MonkeyBoard.Builder.Build(null, new Size(1000, 300), 2.25, out _);
        ...
        if(MainViewModel.IsMockKeyboardVisible) {
            ...
            if(show_windowless_kb) {
                //kbv = MonkeyBoard.Builder.Build(_conn, KeyboardViewModel.GetTotalSizeByScreenSize(this.Bounds.Size, kbvm.KeyboardFlags.HasFlag(KeyboardFlags.Portrait)), scale, out _);
